              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                  ...
                  <p className="leading-relaxed">
                    ...
                    their recipe, including ingredients and instructions. It's
                    the foundation of their culinary creation.
                  </p>
                </div>
              </div>
            </div>
            <div className="flex relative pb-20 sm:items-center md:w-full mx-auto">
              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                  ...
                  <p className="leading-relaxed">
                    Once the recipe is filled out, users submit it for review.
                    It's like handing over their culinary masterpiece to the
                    judges.
                  </p>
                </div>
              </div>
            ...
            <div className="flex relative pb-20 sm:items-center md:w-full mx-auto">
              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                  ...
                  <p className="leading-relaxed">
                    After submission, an admin carefully examines the recipe. If
                    it meets the criteria, it receives the coveted approval
                    stamp. 🌟
                  </p>
                </div>
              </div>
              ...
              <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                ...
                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                  ...
                  <p className="leading-relaxed">
                    ...
                    virtual "wall" of culinary delights, waiting to be savored
                    by others. Bon appétit! 🍽️
                  </p>
                </div>
              </div>
            </div>
